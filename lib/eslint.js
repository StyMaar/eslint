 ...
 * @param {string} rx The text to escape.
...
/**
 * Determines if a given string value is equivalent to the boolean value true.
 * @param {string} str The string to check.
 * @returns {boolean} True if the value is equivalent to true, false if not.
 * @private
 */
...
/**
 * Updates rule configuration based on comments found in the code.
 * @param {ASTNode} ast The root AST node.
 * @param {Config} config The current configuration to modify.
 * @returns {void}
 * @private
 */
